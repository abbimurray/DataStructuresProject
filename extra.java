...
/*option 1 -- works when user enters graph.txt and is also not case sensitive
option 2 -- works, not case sensitive and ok for spaces after the word, error handling 
option 3 -- works, not case sensitive, also checks if an edge already exists between two sites entered 
if it does, it will not add the edge and will display a message saying that an edge already exists
option 4 --works + error handling
option 5, 6  
*/
public class extra {
